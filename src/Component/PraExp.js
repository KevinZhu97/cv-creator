...
class PraExp extends react.Component {
    ...
    addQuali = () => {
        return <div className="addQuali">
            <div>
                <label>Company Name: </label> <input type='text' onChange={this.updateCompany} value={this.state.company}></input>
            </div>
            <div>
            ...
            <div>
                <label>Experiences: </label> <input type='text' onChange={this.updateExp} value={this.state.exp}></input>
            </div>
